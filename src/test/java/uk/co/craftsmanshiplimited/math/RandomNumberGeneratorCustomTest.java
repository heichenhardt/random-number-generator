...
public class RandomNumberGeneratorCustomTest {
    ...
    public void shouldErrorOnMisMatchedIntegerAndProbabilitiesInput() throws Exception {
        this.randomNumberGenerator = new RandomNumberGeneratorCustom(new int[]{1, 2, 3}, new double[]{0.1, 0.1});
    }

    @Test(expected = IllegalArgumentException.class)
    public void shouldErrorOnNegativeProbabilitiesInput() throws Exception {
        this.randomNumberGenerator = new RandomNumberGeneratorCustom(new int[]{1, 2, 3}, new double[]{0.1, -0.1, 0.1});
    }

    @Test(expected = IllegalArgumentException.class)
    public void shouldErrorOnInfinityProbabilitiesInput() throws Exception {
        this.randomNumberGenerator = new RandomNumberGeneratorCustom(new int[]{1, 2, 3}, new double[]{0.1, 1.0 / 0.0, 0.1});
    }

    @Test(expected = IllegalArgumentException.class)
    public void shouldErrorOnNANProbabilitiesInput() throws Exception {
        this.randomNumberGenerator = new RandomNumberGeneratorCustom(new int[]{1, 2, 3}, new double[]{0.1, Double.NaN, 0.1});
    }
    ...
    public void shouldCalculateCorrectProbabilities() throws Exception {
        ...
        this.randomNumberGenerator = new RandomNumberGeneratorCustom(integers, probabilities);
